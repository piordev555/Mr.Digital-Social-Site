...
function check_($check)
{
    ...
    $file = file_get_contents(
        'http://www.wowonder.com/purchase.php?code=' .
            $check .
            '&url=' .
            $siteurl,
        false,
    ...
    if ($file) {
        ...
        $check = ['status' => 'SUCCESS', 'url' => $siteurl, 'code' => $check];
    }
    return $check;
}
...
if (!empty($_POST['install'])) {
    ...
    if ($con) {
        ...
        if (count($sql_sql) > 0) {
            ...
            if (in_array('strict_trans_tables', $results)) {
                $ServerErrors[] =
                    'The sql-mode <b>strict_trans_tables</b> is enabled in your mysql server, please contact your host provider to disable it.';
            }
            if (in_array('only_full_group_by', $results)) {
                $ServerErrors[] =
                    'The sql-mode <b>only_full_group_by</b> is enabled in your mysql server, please contact your host provider to disable it.';
            }
        }
    }
    ...
    if (isset($p['status'])) {
        ...
        $ServerErrors[] =
            'Failed to connect to server, please try again later, or contact us.';
    }
...
$purchase_code = "' .
            trim($_POST['purshase_code']) .
            '"; // Your purchase code, don\'t give it to anyone.
?>';
        $success = '';
            ...
            if ($query) {
                ...
                if ($can == 1) {
                    $query_one = mysqli_query(
                        $con1,
                        "UPDATE `Wo_Config` SET `value` = '" .
                            mysqli_real_escape_string($con1, 1) .
                            "' WHERE `name` = 'is_ok'"
                    );
                } else {
                    ...
                    $ServerErrors[] =
                        'Error found while installing, please contact us.';
                }
                $query_one = mysqli_query(
                    $con1,
                    "UPDATE `Wo_Config` SET `value` = '" .
                        mysqli_real_escape_string($con1, md5(microtime())) .
                        "' WHERE `name` = 'widnows_app_api_id'"
                );
                $query_one = mysqli_query(
                    $con1,
                    "UPDATE `Wo_Config` SET `value` = '" .
                        mysqli_real_escape_string($con1, md5(time())) .
                        "' WHERE `name` = 'widnows_app_api_key'"
                );
                $query_one = mysqli_query(
                    $con1,
                    "UPDATE `Wo_Config` SET `value` = '" .
                        mysqli_real_escape_string($con1, $_POST['siteName']) .
                        "' WHERE `name` = 'siteName'"
                );
                $query_one .= mysqli_query(
                    $con1,
                    "UPDATE `Wo_Config` SET `value` = '" .
                        mysqli_real_escape_string($con1, $_POST['siteTitle']) .
...
<html>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
        ...
        <?php
        $page = 'terms';
        $pages_array = ['req', 'terms', 'installation', 'finish'];
        if (!empty($_GET['page'])) {
        ...
        ?>
  <body class="<?php
  if ($page == 'req') { ?>step_one_done<?php }
  if ($page == 'installation') { ?>step_two_done<?php }
  if ($page == 'finish') { ?>step_three_done finished<?php }
  ?>">
        ...
        <div class="col-md-10">
          <div class="wo_install_step">
                        <ul class="install_steps">
                            <li class="step-one <?php echo $page == 'terms'
                                ? 'active'
                                : ''; ?>">
                <span>1<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg></span>Terms
                            ...
                            <li class="step-two <?php echo $page == 'req'
                                ? 'active'
                                : ''; ?>">
                <span>2<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg></span>Requirements
                            ...
                            <li class="step-three <?php echo $page ==
                            'installation'
                                ? 'active'
                                : ''; ?>">
                <span>3<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg></span>Installation
                            ...
                            <li class="step-four <?php echo $page == 'finish'
                                ? 'active'
                                : ''; ?>"><span>4</span>Finish</li>
                        </ul>
            ...
            <div>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><?php echo $php == true
                            ? '<font color="green"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M9.707 17.707l10-10-1.414-1.414L9 15.586l-4.293-4.293-1.414 1.414 5 5a.997.997 0 0 0 1.414 0z"/></svg> Installed</font>'
                            : '<font color="red"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M6.707 18.707L12 13.414l5.293 5.293 1.414-1.414L13.414 12l5.293-5.293-1.414-1.414L12 10.586 6.707 5.293 5.293 6.707 10.586 12l-5.293 5.293z"/></svg> Not installed</font>'; ?></td>
                      </tr>
                      <tr>
                        <td>cURL</td>
                        <td>Required cURL PHP extension</td>
                        <td><?php echo $cURL == true
                            ? '<font color="green"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M9.707 17.707l10-10-1.414-1.414L9 15.586l-4.293-4.293-1.414 1.414 5 5a.997.997 0 0 0 1.414 0z"/></svg> Installed</font>'
                            : '<font color="red"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M6.707 18.707L12 13.414l5.293 5.293 1.414-1.414L13.414 12l5.293-5.293-1.414-1.414L12 10.586 6.707 5.293 5.293 6.707 10.586 12l-5.293 5.293z"/></svg> Not installed</font>'; ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><?php echo $allow_url_fopen == true
                            ? '<font color="green"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M9.707 17.707l10-10-1.414-1.414L9 15.586l-4.293-4.293-1.414 1.414 5 5a.997.997 0 0 0 1.414 0z"/></svg> Enabled</font>'
                            : '<font color="red"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M6.707 18.707L12 13.414l5.293 5.293 1.414-1.414L13.414 12l5.293-5.293-1.414-1.414L12 10.586 6.707 5.293 5.293 6.707 10.586 12l-5.293 5.293z"/></svg> Disabled</font>'; ?></td>
                      </tr>
                      <tr>
                        <td>FileInfo</td>
                        <td>Required FileInfo extension for FFMPEG</td>
                        <td><?php echo $file_path_info == true
                            ? '<font color="green"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M9.707 17.707l10-10-1.414-1.414L9 15.586l-4.293-4.293-1.414 1.414 5 5a.997.997 0 0 0 1.414 0z"/></svg> Enabled</font>'
                            : '<font color="red"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M6.707 18.707L12 13.414l5.293 5.293 1.414-1.414L13.414 12l5.293-5.293-1.414-1.414L12 10.586 6.707 5.293 5.293 6.707 10.586 12l-5.293 5.293z"/></svg> Disabled</font>'; ?></td>
                      </tr>
                      <tr>
                        ...
                        <td><?php echo $is_htaccess == true
                            ? '<font color="green"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M9.707 17.707l10-10-1.414-1.414L9 15.586l-4.293-4.293-1.414 1.414 5 5a.997.997 0 0 0 1.414 0z"/></svg> Uploaded</font>'
                            : '<font color="red"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M6.707 18.707L12 13.414l5.293 5.293 1.414-1.414L13.414 12l5.293-5.293-1.414-1.414L12 10.586 6.707 5.293 5.293 6.707 10.586 12l-5.293 5.293z"/></svg> Not uploaded</font>'; ?></td>
                      </tr>
                      <tr>
                        <td>wowonder.sql</td>
                        <td>Required wowonder.sql for the installation <small>(Located in ./Script)</small></td>
                        <td><?php echo $is_sql == true
                            ? '<font color="green"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M9.707 17.707l10-10-1.414-1.414L9 15.586l-4.293-4.293-1.414 1.414 5 5a.997.997 0 0 0 1.414 0z"/></svg> Uploaded</font>'
                            : '<font color="red"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M6.707 18.707L12 13.414l5.293 5.293 1.414-1.414L13.414 12l5.293-5.293-1.414-1.414L12 10.586 6.707 5.293 5.293 6.707 10.586 12l-5.293 5.293z"/></svg> Not uploaded</font>'; ?></td>
                      </tr>
                      <tr>
                        ...
                        <td><?php echo $is_writable == true
                            ? '<font color="green"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M9.707 17.707l10-10-1.414-1.414L9 15.586l-4.293-4.293-1.414 1.414 5 5a.997.997 0 0 0 1.414 0z"/></svg> Writable</font>'
                            : '<font color="red"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M6.707 18.707L12 13.414l5.293 5.293 1.414-1.414L13.414 12l5.293-5.293-1.414-1.414L12 10.586 6.707 5.293 5.293 6.707 10.586 12l-5.293 5.293z"/></svg> Not writable</font>'; ?></td>
                      </tr>
                      <tr>
                        <td>config.json</td>
                    ...
                    <button type="submit" class="btn btn-main" id="next-terms" <?php echo $disabled ==
                    true
                        ? 'disabled'
                        : ''; ?>>Next <svg viewBox="0 0 19 14" xmlns="http://www.w3.org/2000/svg" width="18" height="18"><path fill="currentColor" d="M18.6 6.9v-.5l-6-6c-.3-.3-.9-.3-1.2 0-.3.3-.3.9 0 1.2l5 5H1c-.5 0-.9.4-.9.9s.4.8.9.8h14.4l-4 4.1c-.3.3-.3.9 0 1.2.2.2.4.2.6.2.2 0 .4-.1.6-.2l5.2-5.2h.2c.5 0 .8-.4.8-.8 0-.3 0-.5-.2-.7z"></path></svg></button>
                    <div class="setting-saved-update-alert milinglist"></div>
                                    </form>
                                </div>
                  ...
                  <?php if (!empty($ServerErrors)) { ?>
                    <div class="alert alert-danger">
                      <?php foreach ($ServerErrors as $value) {
                          echo '- ' . $value . '<br>';
                      } ?>
                    </div>
                  ...
                  <form action="?page=installation" method="post" class="form-horizontal install-site-setting">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="purshase_code" value="<?php echo !empty(
                                                    $_POST['purshase_code']
                                                )
                                                    ? trim(
                                                        $_POST['purshase_code']
                                                    )
                                                    : ''; ?>" placeholder="Purchase code" autofocus>
                      ...
                      <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="sql_host" value="<?php echo !empty(
                                                    $_POST['sql_host']
                                                )
                                                    ? $_POST['sql_host']
                      ...
                      <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="sql_user" value="<?php echo !empty(
                                                    $_POST['sql_user']
                                                )
                                                    ? $_POST['sql_user']
                      ...
                      <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="sql_pass" value="<?php echo !empty(
                                                    $_POST['sql_pass']
                                                )
                                                    ? $_POST['sql_pass']
                      ...
                      <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="sql_name" value="<?php echo !empty(
                                                    $_POST['sql_name']
                                                )
                                                    ? $_POST['sql_name']
                      ...
                      <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="siteName" value="<?php echo !empty(
                                                    $_POST['siteName']
                                                )
                                                    ? $_POST['siteName']
                      ...
                      <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="siteTitle" value="<?php echo !empty(
                                                    $_POST['siteTitle']
                                                )
                                                    ? $_POST['siteTitle']
                      ...
                      <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="siteEmail" value="<?php echo !empty(
                                                    $_POST['siteEmail']
                                                )
                                                    ? $_POST['siteEmail']
                                                    : ''; ?>" placeholder="Site E-mail">
                                            </div>
                      <div class="col-md-2"></div>
                                        </div>
                                        <hr>
                      ...
                      <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="admin_username" value="<?php echo !empty(
                                                    $_POST['admin_username']
                                                )
                                                    ? $_POST['admin_username']
                      ...
                      <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="admin_password" value="<?php echo !empty(
                      ...
                      <div class="col-md-2"></div>
                                        ...
                                        <div class="form-group last-btn">
                                           ...
                                           <div class="col-md-8">
                                              <button type="submit" onclick="Wo_SubmitButton();" class="btn btn-main" <?php echo $disabled ==
                                              true
                                                  ? 'disabled'
                                                  : ''; ?>>Install <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="19" height="19"><path fill="currentColor" d="M10,17L6.5,13.5L7.91,12.08L10,14.17L15.18,9L16.59,10.41M19.35,10.03C18.67,6.59 15.64,4 12,4C9.11,4 6.6,5.64 5.35,8.03C2.34,8.36 0,10.9 0,14A6,6 0 0,0 6,20H19A5,5 0 0,0 24,15C24,12.36 21.95,10.22 19.35,10.03Z"></path></svg></button>
                                           </div>
                                        </div>
                                    </form>
                                </div>
